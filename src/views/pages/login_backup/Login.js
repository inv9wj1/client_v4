              ...
              <CCard className="text-white bg-info py-5" style={{ width: '44%' }}>
                <CCardBody className="text-center">
                  <div>
                    ...
                    <p>
                      Hey, <br />
                      Welcome to new experience and interface to the Mainframe World.
                      If you are new here, please Register using your email address
                      and a new account will be created for you. You can use your account to login.
                    </p>
                    <Link to="/register">
